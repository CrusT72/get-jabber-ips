### Настройки GeoIP dashboard в Grafana с выгрузкой данных из лога Cisco Expressway (версия на которой тестировалось -12.5.6)
The script produces the following output:

![Example output](docs/images/C4JjLpIBp6.png)
***
Краткое описание работы:
python-скрипт (gju.py) выполняет парсинг syslog-файла для получения 3 значений: login-пользователя, IP-адрес с которого он подключался и времени подключения.
далее скрипт последовательно выполняет запросы с сервису 'https://ipinfo.io/' для получения значений о IP адресе:
- Страна
- Город
- Регион
- ASN 
...
Затем скрипт вносит полученные данные в локально созданную MySQL БД с таблицей JABBER которую будет использовать Grafana для отображения точек на карте.
